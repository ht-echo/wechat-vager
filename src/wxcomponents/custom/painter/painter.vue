<template>
<uni-shadow-root class="custom-painter-painter"><canvas canvas-id="k-canvas" :style="(painterStyle)+(customStyle)"></canvas></uni-shadow-root>
</template>
...
global['__wxRoute'] = 'custom/painter/painter'
...
export default global['__wxComponents']['custom/painter/painter']
</script>
